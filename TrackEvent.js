          ...
          data={[
            ...
            },
            {
              ...
              action: () => {
                ...
                ReactMoE.trackEvent("mycustomevent");
              },
            },
            {
              id: "1",
              ...
              action: () => {
                ...
                booked.addAttribute("models", ["iPhone 12"]);
                booked.addAttribute("mixedArray", ["iphone 12", 4, "iphone 11", 5]);
                booked.addAttribute("product", "iPhone");
                booked.addAttribute("currency", "AED");
                booked.addAttribute("price", 400);
                booked.addAttribute("new_item", true);
                booked.addDateAttribute("purchase_date", "2023-07-10T12:42:10Z");
                ...
                ReactMoE.trackEvent("mycustomevent", booked);
              },
            },
            {
              id: "2",
              ...
              action: () => {
                ...
                ReactMoE.trackEvent("mycustomevent", properties);
              },
            },
          ]}
